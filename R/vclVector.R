...
setMethod('vclVector', 
          ...
          function(data, length, type=NULL, ctx_id = NULL){
            ...
            if(is.null(ctx_id)) {
                ...
                device = theContexts[theContexts$context == ctx_id,  ]
            }
              ...
              data = switch(type,
                            integer = {
                                new("ivclVector", 
                                    address=vectorToVCL(data, 4L, context_index),
                            ...
                            float = {
                                new("fvclVector", 
                                    address=vectorToVCL(data, 6L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
                            ...
                            double = {
                                ...
                                new("dvclVector",
                                    address = vectorToVCL(data, 8L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
...
setMethod('vclVector', 
          ...
          function(data, length, type=NULL, ctx_id=NULL){
              ...
              data = switch(type,
                            integer = {
                                new("ivclVector", 
                                    address=emptyVecVCL(length, 4L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
                            ...
                            float = {
                                new("fvclVector", 
                                    address=emptyVecVCL(length, 6L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
                            ...
                            double = {
                                assert_has_double(device_index, context_index)
                                new("dvclVector",
                                    address = emptyVecVCL(length, 8L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
...
setMethod('vclVector', 
          ...
          function(data, length, type=NULL, ctx_id = NULL){
              ...
              data = switch(type,
                            integer = {
                                new("ivclVector", 
                                    address=cpp_scalar_vclVector(data, length, 4L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
                            ...
                            float = {
                                new("fvclVector", 
                                    address=cpp_scalar_vclVector(data, length, 6L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
                            ...
                            double = {
                                assert_has_double(device_index, context_index)
                                new("dvclVector",
                                    address = cpp_scalar_vclVector(data, length, 8L, context_index),
                                    .context_index = context_index,
                                    .platform_index = platform_index,
                                    .platform = platform_name,
                                    .device_index = device_index,
          ...
          function(data, length=NULL, type=NULL, ctx_id = NULL, col = NULL, row = NULL){
              ...
              if(!is.null(col)){
                  data = switch(type,
                                integer = {
                                    new("ivclVector", 
                                        address=extractCol(data@address, col - 1, 4L, context_index),
                                        .context_index = context_index,
                                        .platform_index = platform_index,
                                        .platform = platform_name,
                                        .device_index = device_index,
                                ...
                                float = {
                                    new("fvclVector", 
                                        address=extractCol(data@address, col - 1, 6L, context_index),
                                        .context_index = context_index,
                                        .platform_index = platform_index,
                                        .platform = platform_name,
                                        .device_index = device_index,
                                ...
                                double = {
                                    new("dvclVector",
                                        address = extractCol(data@address, col - 1, 8L, context_index),
                                        .context_index = context_index,
                                        .platform_index = platform_index,
                                        .platform = platform_name,
                                        .device_index = device_index,
                  ...
                  data = switch(type,
                                integer = {
                                    new("ivclVector", 
                                        address=extractRow(data@address, row - 1, 4L, context_index),
                                        .context_index = context_index,
                                        .platform_index = platform_index,
                                        .platform = platform_name,
                                        .device_index = device_index,
                                ...
                                float = {
                                    new("fvclVector", 
                                        address=extractRow(data@address, row - 1, 6L, context_index),
                                        .context_index = context_index,
                                        .platform_index = platform_index,
                                        .platform = platform_name,
                                        .device_index = device_index,
                                ...
                                double = {
                                    new("dvclVector",
                                        address = extractRow(data@address, row - 1, 8L, context_index),
                                        .context_index = context_index,
                                        .platform_index = platform_index,
                                        .platform = platform_name,
                                        .device_index = device_index,
